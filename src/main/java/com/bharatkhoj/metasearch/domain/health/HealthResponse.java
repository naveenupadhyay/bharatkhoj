...
public class HealthResponse implements Serializable {
    ...
    private Map<String, DependentService> dependentService;
    ...
    public Map<String, DependentService> getDependentService() {
        return dependentService;
    }

    public void setDependentService(Map<String, DependentService> dependentService) {
